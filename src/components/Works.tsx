...
const projectsData: Project[] = [
  {
    ...
    description:
      "A high-end, responsive digital presence for a legal practice, focusing on authority, readability, and smooth user journey transitions.",
    longDescription:
      "Justis is a bespoke web solution tailored for modern law firms. It prioritizes professional aesthetics and accessibility while leveraging GSAP for sophisticated, non-intrusive scroll animations. The site architecture is optimized for high-conversion lawyer-client engagement, ensuring that practice areas, attorney profiles, and contact channels are easily discoverable.",
    features: [
      "Sophisticated scroll-triggered animations using GSAP",
      "Content-first layout optimized for readability and trust",
      "Integrated contact inquiry forms with client-side validation",
      "Accessible, performance-optimized typography and layout",
  ...
  },
  {
    ...
    description:
      "A streamlined platform that empowers professionals to generate high-quality, customizable portfolios with a clean, modern aesthetic.",
    longDescription:
      "Vantage simplifies personal branding by providing a dynamic interface for users to build and deploy professional portfolios. By utilizing a robust Next.js backend, it allows for seamless data persistence and server-side rendering, ensuring that individual portfolios load instantly and rank effectively for search engines.",
    features: [
      "Drag-and-drop style customization for user sections",
      "Server-side rendering for optimal SEO and fast initial load",
      "Secure user authentication and data management using SQLite",
      "Real-time preview mode to visualize changes before publishing",
      "Responsive, component-based architecture for custom themes",
    ],
  ...
  },
  {
    ...
    description:
      "An intelligent, AI-powered resume optimization tool that tailors user experience to specific job descriptions for maximum ATS compatibility.",
    longDescription:
      "ResuTailor leverages modern LLM integration to help job seekers bridge the gap between their experience and employer requirements. The application parses job descriptions and provides real-time, actionable feedback to optimize resumes, ensuring that users pass Applicant Tracking Systems (ATS) while maintaining a professional and compelling narrative.",
    features: [
      "Real-time keyword matching against job descriptions",
      "Smart content suggestions powered by AI integration",
      "PDF generation and export with custom design templates",
      "ATS-friendly formatting and structural optimization",
      "Intuitive dashboard for managing multiple resume versions",
    ],
